...
public class Parents extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jAdd_Button_.setBounds(180, 90, 24, 30);
    ...
    private void jAdd_Button_MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jAdd_Button_MouseClicked
        AddParents addParent = new AddParents();
        addParent.setVisible(true);
        addParent.pack();
        addParent.setLocationRelativeTo(null);
        addParent.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    ...
    private void jDelete_Button_MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jDelete_Button_MouseClicked
        ...
        String query = "DELETE FROM `parent_details` WHERE ID = '"+id+"'";
