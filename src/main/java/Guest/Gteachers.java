 ...
 * @author Aby Balu
 */
public class Gteachers extends javax.swing.JFrame {
    ...
    {   
        ...
        String query = "SELECT `First Name`, `Email`, `Department`, `Position`, `Subject`,`Phone No` FROM `teacher_details`";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gteachers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
