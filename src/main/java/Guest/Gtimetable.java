 ...
 * @author Aby Balu
 */
public class Gtimetable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jPanel1);
        jPanel1.setBounds(200, 132, 0, 273);
    ...
    private void jButton_TimeTable_MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton_TimeTable_MouseClicked
        Gtimetable timetable = new Gtimetable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gtimetable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gtimetable().setVisible(true);
            }
        });
    }
