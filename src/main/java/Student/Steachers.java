 ...
 * @author Aby Balu
 */
public class Steachers extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Steachers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
