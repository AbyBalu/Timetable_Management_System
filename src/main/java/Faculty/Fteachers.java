 ...
 * @author Aby Balu
 */
public class Fteachers extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fteachers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
