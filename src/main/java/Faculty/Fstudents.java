 ...
 * @author Aby Balu
 */
public class Fstudents extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fstudents.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
